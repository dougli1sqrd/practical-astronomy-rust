...
pub fn lunar_eclipse_occurrence(
    ...
    let g_date_of_full_moon_day = pa_m::jdc_day(julian_date_of_full_moon);
    let integer_day = (g_date_of_full_moon_day).floor();
    let g_date_of_full_moon_month = pa_m::jdc_month(julian_date_of_full_moon);
    let g_date_of_full_moon_year = pa_m::jdc_year(julian_date_of_full_moon);
    let ut_of_full_moon_hours = g_date_of_full_moon_day - integer_day;
    let _local_civil_time_hours = pa_m::ut_lct(
    ...
    let local_civil_date_day = pa_m::ut_lc_day(
        ut_of_full_moon_hours,
        0.0,
        0.0,
        daylight_saving,
    ...
    let local_civil_date_month = pa_m::ut_lc_month(
        ut_of_full_moon_hours,
        0.0,
        0.0,
        daylight_saving,
    ...
    let local_civil_date_year = pa_m::ut_lc_year(
        ut_of_full_moon_hours,
        0.0,
        0.0,
        daylight_saving,
    ...
    let eclipse_occurrence = pa_m::lunar_eclipse_occurrence(
        daylight_saving,
        zone_correction_hours,
        local_date_day,
        local_date_month,
...
pub fn lunar_eclipse_circumstances(
    ...
    let _eclipse_occurrence = pa_m::lunar_eclipse_occurrence(
        daylight_saving,
        zone_correction_hours,
        local_date_day,
        local_date_month,
    ...
    let ut_max_eclipse = pa_m::ut_max_lunar_eclipse(
        local_date_day,
        local_date_month,
        local_date_year,
        daylight_saving,
    ...
    let ut_first_contact = pa_m::ut_first_contact_lunar_eclipse(
        local_date_day,
        local_date_month,
        local_date_year,
        daylight_saving,
    ...
    let ut_last_contact = pa_m::ut_last_contact_lunar_eclipse(
        local_date_day,
        local_date_month,
        local_date_year,
        daylight_saving,
    ...
    let ut_start_umbral_phase = pa_m::ut_start_umbra_lunar_eclipse(
        local_date_day,
        local_date_month,
        local_date_year,
        daylight_saving,
    ...
    let ut_end_umbral_phase = pa_m::ut_end_umbra_lunar_eclipse(
        local_date_day,
        local_date_month,
        local_date_year,
        daylight_saving,
    ...
    let ut_start_total_phase = pa_m::ut_start_total_lunar_eclipse(
        local_date_day,
        local_date_month,
        local_date_year,
        daylight_saving,
    ...
    let ut_end_total_phase = pa_m::ut_end_total_lunar_eclipse(
        local_date_day,
        local_date_month,
        local_date_year,
        daylight_saving,
    ...
    let eclipse_magnitude1 = pa_m::mag_lunar_eclipse(
        local_date_day,
        local_date_month,
        local_date_year,
        daylight_saving,
...
pub fn solar_eclipse_occurrence(
    ...
    let g_date_of_new_moon_day = pa_m::jdc_day(julian_date_of_new_moon);
    let integer_day = (g_date_of_new_moon_day).floor();
    let g_date_of_new_moon_month = pa_m::jdc_month(julian_date_of_new_moon);
    let g_date_of_new_moon_year = pa_m::jdc_year(julian_date_of_new_moon);
    ...
    let eclipse_occurrence = pa_m::solar_eclipse_occurrence(
        daylight_saving,
        zone_correction_hours,
        local_date_day,
        local_date_month,
...
pub fn solar_eclipse_circumstances(
    ...
    let _eclipse_occurrence = pa_m::solar_eclipse_occurrence(
        daylight_saving,
        zone_correction_hours,
        local_date_day,
        local_date_month,
    ...
    let ut_max_eclipse = pa_m::ut_max_solar_eclipse(
        local_date_day,
        local_date_month,
        local_date_year,
        daylight_saving,
    ...
    let ut_first_contact = pa_m::ut_first_contact_solar_eclipse(
        local_date_day,
        local_date_month,
        local_date_year,
        daylight_saving,
    ...
    let ut_last_contact = pa_m::ut_last_contact_solar_eclipse(
        local_date_day,
        local_date_month,
        local_date_year,
        daylight_saving,
    ...
    let magnitude = pa_m::mag_solar_eclipse(
        local_date_day,
        local_date_month,
        local_date_year,
        daylight_saving,
